...
public class Obsolete_StorySheetReader : MonoBehaviour
{
    ...
    private const string OBS_STORY_SHEET_URL = "https://sheets.googleapis.com/v4/spreadsheets/1SgYjI9zV2c22x3EGEeSDvvWy7uS2QMvWP8qnpyryZPs/values:batchGet?ranges=StorySheet&key=AIzaSyDxlgY5nx2_JX89Grs3KZ7cnxlpRO2Nedg";
    ...
    {
        Debug.Log("Sheet Data loaded by Obsolete_StorySheetReader (one)");
        UnityWebRequest www = UnityWebRequest.Get(OBS_STORY_SHEET_URL);
