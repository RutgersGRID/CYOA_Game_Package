...
public class Obsolete_StorySheetReaderTwo : MonoBehaviour
{
    ...
    // private const string OBS_STORY_input_URL = "https://sheets.googleapis.com/v4/spreadsheets/<OBSOLETE>/values/StorySheet?key=AIzaSyDxlgY5<nx2_JX89Grs3KZ7cnxlpRO2Nedg";
