...
public class GoogleSheetReaderTwo : MonoBehaviour
{
    ...
    private const string CODES_SHEET_URL = "https://sheets.googleapis.com/v4/spreadsheets/1cC9iRPYMR9jgyKbeBM-wBO03rG5SPvONt8t-5fNJrTs/values/Codes?key=AIzaSyDxlgY5nx2_JX89Grs3KZ7cnxlpRO2Nedg"; 
    ...
    public IEnumerator ObtainSheetData()
    {
        ...
        UnityWebRequest www = UnityWebRequest.Get(CODES_SHEET_URL);
